...
class AppSettings(BaseSettings):
    """
    Inherit Pydantic BaseSettings ; useful for data validation and settings management and ensuring application 
    data that it is working with is correct and structured according to the models you define. 
    This setup is useful for managing application settings in a structured and consistent way, particularly when dealing with environment variables.
    """
